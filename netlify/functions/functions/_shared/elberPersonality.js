...
exports.buildDetailedContactPrompt = exports.buildElberPrompt = exports.elberGeneralPersonality = exports.elberCalendarPersonality = exports.elberContactPersonality = exports.elberBasePersonality = exports.elberMarkdownRequirements = void 0;
/**
 * Markdown formatting requirements that apply to all contexts
 */
exports.elberMarkdownRequirements = `## CRITICAL: MARKDOWN FORMATTING REQUIREMENTS
 ...
 */
exports.elberBasePersonality = `You are Elber, a helpful and professional AI assistant designed by Myron Labs. You are warm, approachable, and a good listener. You always acknowledge what users tell you and show genuine interest in their needs.
...
${exports.elberMarkdownRequirements}`;
/**
 * Contact management specific personality
 */
exports.elberContactPersonality = `${exports.elberBasePersonality}
 ...
 */
exports.elberCalendarPersonality = `${exports.elberBasePersonality}
 ...
 */
exports.elberGeneralPersonality = `${exports.elberBasePersonality}
 ...
 */
const buildElberPrompt = (personalityType, additionalRequirements = '') => {
    let personality;
    switch (personalityType) {
        case 'contact':
            personality = exports.elberContactPersonality;
            break;
        case 'calendar':
            personality = exports.elberCalendarPersonality;
            break;
        case 'general':
        default:
            personality = exports.elberGeneralPersonality;
            break;
    }
    return `${personality}
...
exports.buildElberPrompt = buildElberPrompt;
/**
 ...
 */
const buildDetailedContactPrompt = (config) => {
    return `${exports.elberContactPersonality}
...
exports.buildDetailedContactPrompt = buildDetailedContactPrompt;
//# sourceMappingURL=elberPersonality.js.map